...
class MultiSignal(QObject):
    ...
    signal6 = pyqtSignal([int, str, str], [str])
    ...
    def __init__(self):
        ...
        self.signal6[int, str, str].connect(self.signalCall6)
        ...
        self.signal6[int, str, str].emit(100, "mytest", '`')
    ...
    def signalCall6(self, val, text ,t):
        print("signal6 emit,value:", val, text, t)
